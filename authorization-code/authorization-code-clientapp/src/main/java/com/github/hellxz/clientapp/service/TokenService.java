package com.github.hellxz.clientapp.service;


import com.github.hellxz.clientapp.config.OAuth2ClientProperties;
import com.github.hellxz.clientapp.config.OAuth2ServerProperties;
import com.github.hellxz.clientapp.consts.GrantType;
import com.github.hellxz.clientapp.domain.ClientUser;
import com.github.hellxz.clientapp.dto.TokenDTO;
import com.github.hellxz.clientapp.vo.UserInfo;
...
public class TokenService {
    ...
    public void tryGetUserInfo(ModelAndView mv, ClientUser currentUser) {
        ...
        RequestEntity<MultiValueMap<String, String>> requestEntity
                = new RequestEntity<>(headers, HttpMethod.GET, URI.create("http://localhost:7081/userInf"));
